...
local PABStrings = {
    ...
    -- -----------------------------------------------------------------------------------------------------------------
    -- Menú de PABanking --
    SI_PA_MENU_BANKING_DESCRIPTION = "PABanking puede mover divisas, objetos de elaboración y otros ítems entre la mochila de tu personaje y el banco",
    ...
    -- Objetos de Elaboración --
    SI_PA_MENU_BANKING_CRAFTING_HEADER = "Objetos de Elaboración",
    SI_PA_MENU_BANKING_CRAFTING_ENABLE = "Habilitar Banco Automático para Objetos de Elaboración",
    SI_PA_MENU_BANKING_CRAFTING_ENABLE_T = "¿Habilitar depósito y retiro automático en el banco para los diferentes objetos de elaboración?",
    SI_PA_MENU_BANKING_CRAFTING_DESCRIPTION = "Define un comportamiento individual (depositar, retirar o no hacer nada) para los objetos de elaboración",
    SI_PA_MENU_BANKING_CRAFTING_ESOPLUS_DESC = "Como miembro de ESO Plus, el depósito/retiro de materiales de elaboración no es relevante, ya que todos pueden llevarse en cantidad infinita en la Bolsa de Elaboración",
    SI_PA_MENU_BANKING_CRAFTING_GLOBAL_MOVEMODE = "Cambiar todos los menús desplegables de objetos de elaboración a",
    SI_PA_MENU_BANKING_CRAFTING_GLOBAL_MOVEMODE_T = "Cambia todos los valores de los menús desplegables de objetos de elaboración a 'Depositar en el banco', 'Retirar a la mochila' o 'No hacer nada'",
