...
ZO_CreateStringId("SI_CWA_JEWELRY_WRIT_NAME", "Jewelry Crafting Writ")
...
ZO_CreateStringId("SI_CWA_JEWELRY", "Jewelry")
...
ZO_CreateStringId("SI_CWA_MW_COMPLETE_AD", "Travel to Elden Root")
ZO_CreateStringId("SI_CWA_MW_COMPLETE_EP", "Travel to Mournhold")
ZO_CreateStringId("SI_CWA_MW_COMPLETE_DC", "Travel to Wayrest")

--OPTIONS DATA
ZO_CreateStringId("SI_CWA_DISPLAY_AT_STATION_NAME", "Display at crafting station")
ZO_CreateStringId("SI_CWA_DISPLAY_AT_STATION_DESC", "Display the writ window when you visit crafting station.")

ZO_CreateStringId("SI_CWA_SAVE_WINDOW_LOC_NAME", "Remember window position")
ZO_CreateStringId("SI_CWA_SAVE_WINDOW_LOC_DESC", "Remember your last window position.")

ZO_CreateStringId("SI_CWA_DISPLAY_AT_GB_NAME", "Display at Guild Bank")
ZO_CreateStringId("SI_CWA_DISPLAY_AT_GB_DESC", "Display the writ window when you visit guild bank.")
...
ZO_CreateStringId("SI_CWA_DISPLAY_AT_GSTORE_DESC", "Display the writ window when you visit a guild store.")

ZO_CreateStringId("SI_CWA_DISPLAY_AT_BANK_NAME", "Display at Bank")
ZO_CreateStringId("SI_CWA_DISPLAY_AT_BANK_DESC", "Display the writ window when you visit bank.")
