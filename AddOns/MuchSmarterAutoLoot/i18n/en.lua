...
ZO_CreateStringId("MSAL_HELP_GEAR","|c999999In the case of set gear, for and only for |cdb8e0bcollected gear that has not been looted|c999999, the addon will use subsequent filters to further determine whether or not to loot it|r")
...
ZO_CreateStringId("MSAL_CONSIDERATE_MODE_TOOLTIP","When enabled, looting resource nodes and opening locked chests will ignore the rules and loot all of their contents, thus leaving no remnants on the map. \n\nUnwanted items will be destroyed afterward")
...
ZO_CreateStringId("MSAL_AUTOBIND_TOOLTIP","When enabled, the |cdb8e0buncollected|r set items will be autobound when looted. Please use it at your own risk")
...
-- chat box
ZO_CreateStringId("MSAL_CLOSE_LOOT_WINDOW_REMINDER","|c215895 [Lykeion's|cdb8e0b Much Smarter AutoLoot] Close Loot Window is enabled. This will automatically close the looting window after looting the matching items|r")
ZO_CreateStringId("MSAL_DEBUG_MODE_REMINDER","|c215895 [Lykeion's|cdb8e0b Much Smarter AutoLoot] Debug mode is enabled. This will print the looted item info in the chat box|r")
ZO_CreateStringId("MSAL_EXCEED_WARNING","|c215895 [Lykeion's|cdb8e0b Much Smarter AutoLoot] |c215895<<1>>|cdb8e0b looting has been blocked because looting would cause them to exceed the cap|r")
ZO_CreateStringId("MSAL_UPDATE_IMFORM","|c215895 [Lykeion's|cdb8e0b Much Smarter AutoLoot] Addon has been successfully updated to version 4.0.0+, added new |cdb8e0bthird-party price comparison support (TTC, MM and ATT supported)|r. You can find it in Misc Settings submenu and get more detailed information in the tooltip|r")
ZO_CreateStringId("MSAL_THIRD_PARTY_DAFAULT_WARNING","|c215895Some of |cdb8e0bLykeion's Much Smarter AutoLoot|c215895 filters do not work properly due to missing <<1>>. Please check if the corresponding addon has been activated, or change the corresponding filter settings.|r")
