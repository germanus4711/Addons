...
ZO_CreateStringId("MSAL_ENABLE_MSAL_TOOLTIP","The game's built-in AutoLoot would be turned off when enable MSAL. You can also set up a keybinding to toggle the addon on and off")
ZO_CreateStringId("MSAL_USE_ACCOUNT_WIDE","Use Account-Wide Settings")
ZO_CreateStringId("MSAL_USE_ACCOUNT_WIDE_TOOLTIP","When off, switches to independent settings for each character")
ZO_CreateStringId("MSAL_AUTOLOOT_CURRENCY","Autoloot Currencies")
ZO_CreateStringId("MSAL_AUTOLOOT_CURRENCY_TOOLTIP","For capped currencies, when the cap is reached the addon will suspend the looting and prompt")
...
ZO_CreateStringId("MSAL_SHOW_ITEM_LINKS_TOOLTIP","When enabled, links to all looted items will be sent to the chatbox. These links are only visible to you")
...
ZO_CreateStringId("MSAL_QUALITY_THRESHOLD_TOOLTIP","Set a minimum quality threshold for filters supporting this filtration method. 1 represents for white, and so on")
...
ZO_CreateStringId("MSAL_EXCEED_WARNING","<<1>> close to the cap, thus not looted")
...
ZO_CreateStringId("MSAL_LIST_LOOTING_CONFLICT","|cFF3300Attention!|r There is a blacklisted set item <<1>> here, thus the <<2>> is not fully executed")
-- keybinding
