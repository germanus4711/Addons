...
Register("SI_ITEMBROWSER_SOURCE_SPECIAL5" , GetString(SI_JOURNAL_MENU_ANTIQUITIES))
...
Register("SI_ITEMBROWSER_FILTERDROP9"     , GetString(SI_JOURNAL_MENU_ANTIQUITIES))
